...
| F3.1.2 non-production LEDGER_REQUIRED activation | **PASS / pending independent acceptance.** Live operator-laptop overlay activation at accepted SHA `2249522`; committed default remains `LEGACY_PRE_F3`. Evidence: [`f3-1-2-ledger-required-nonprod-activation-evidence.md`](./f3-1-2-ledger-required-nonprod-activation-evidence.md). Production cutover remains unauthorized. |
