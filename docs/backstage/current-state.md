...
| F3.1.3–F3.1.4 | F3.1.3 planning/prompt authoring **GO**; F3.1.3 implementation **NO-GO** pending separate explicit authorization; F3.1.4 **NOT AUTHORIZED** |
