...
| F3.1.2b — Ledger-governed submission integration | **IMPLEMENTED / PUBLISHED** at ADO `2249522` (full SHA `22495229502dabf2d99588599a156d862c5114fa`), direct child of product-convergence `f48dc82`. Committed default remains `LEGACY_PRE_F3`; LEDGER_REQUIRED proven only in controlled tests. Independent architecture/implementation acceptance **pending**. Evidence: [`f3-1-2b-implementation-evidence.md`](./f3-1-2b-implementation-evidence.md). |
| F3.1.2 — First-round submission integration | **ACCEPTED IMPLEMENTATION CONTRACT** — final architecture re-review ACCEPT ([`f3-1-2-final-architecture-rereview.md`](./f3-1-2-final-architecture-rereview.md)). F3.1.2a accepted. F3.1.1c accepted. Product convergence PASS. **F3.1.2b implemented / published; independent acceptance still required**. Operational LEDGER_REQUIRED cutover **not authorized**. Canonical plan: [`f3-1-2-implementation-plan.md`](./f3-1-2-implementation-plan.md). |
