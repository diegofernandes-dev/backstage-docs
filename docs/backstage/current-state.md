...
> **Last updated:** 2026-09-19 (F3.1.1c **IMPLEMENTED / PUBLISHED** at ADO `3b302ab`, parent F3.1.2a `ccee1e1`, pending independent acceptance; F3.1.2a remains CLOSED / ACCEPTED at `ccee1e1`; F3.1.1b CLOSED at `188d8e9`; ADR-013 accepted; F3.1.2 plan **ACCEPTED IMPLEMENTATION CONTRACT**; F3.1.2b remains NO-GO until F3.1.1c is independently accepted)
...
| F3.1.1c — CAB-safe policy baseline publication | **IMPLEMENTED / PUBLISHED — pending independent acceptance** at ADO `3b302ab` (full SHA `3b302ab5c9caab38f96491b389b7ea9fe0b66c2f`), direct child of F3.1.2a `ccee1e1`. New immutable policy `default-change-authorization@2026-09-19.1`: normal-low → primary + CAB; medium/high/emergency unchanged; historical `2026-09-02.1` untouched; activePolicy pin updated; selector bundle unchanged. Evidence: [`f3-1-1c-implementation-evidence.md`](./f3-1-1c-implementation-evidence.md). |
| F3.1.2 — First-round submission integration | **ACCEPTED IMPLEMENTATION CONTRACT** — final architecture re-review ACCEPT ([`f3-1-2-final-architecture-rereview.md`](./f3-1-2-final-architecture-rereview.md)). F3.1.2a accepted. F3.1.1c implemented/published, **acceptance pending**. **F3.1.2b NO-GO** until F3.1.1c is independently accepted. Canonical plan: [`f3-1-2-implementation-plan.md`](./f3-1-2-implementation-plan.md). |
