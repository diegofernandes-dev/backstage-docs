...
> **Last updated:** 2026-09-21 (F3.1.4 **planning prompt authored** — `prompts/f3-1-4-planning.md`; planning execution still requires explicit launch; F3.1.4 implementation **NO-GO**; F3.1.3b **CLOSED / ACCEPTED IMPLEMENTED BASELINE** at ADO `5e70d88`; F3.1.3 **CLOSED / ACCEPTED IMPLEMENTED DECISION + RESUBMISSION BASELINE**; committed default `LEGACY_PRE_F3`; F3.2 **NO-GO**; production cutover unauthorized)
...
| F3.1.3 — Decision command and new-round semantics | **CLOSED / ACCEPTED IMPLEMENTED DECISION + RESUBMISSION BASELINE** at ADO `5e70d88`. Historical plan review **REJECT** preserved ([`f3-1-3-plan-architecture-review.md`](./f3-1-3-plan-architecture-review.md)). Revised-plan re-review **ACCEPT** ([`f3-1-3-revised-plan-architecture-rereview.md`](./f3-1-3-revised-plan-architecture-rereview.md)). Plan is **ACCEPTED IMPLEMENTATION CONTRACT** ([`f3-1-3-implementation-plan.md`](./f3-1-3-implementation-plan.md), [ADR-014](../adr/ADR-014-change-resubmission-authority-and-identity-boundary.md)). `Migration required: NO`. |
...
| F3.1.3b — Rejected-Change resubmission / new Round | **CLOSED / ACCEPTED IMPLEMENTED BASELINE** at ADO `5e70d88` (full SHA `5e70d8818f55072d8568b5eb15bae754abb943d1`), direct child of accepted `6bad066`. Independent acceptance ACCEPT on 2026-09-21 ([`f3-1-3b-architecture-implementation-acceptance.md`](./f3-1-3b-architecture-implementation-acceptance.md)). `POST /changes/:changeId/resubmissions`, dedicated `change.resubmit`, requester-or-immutable-owner authority, frozen identity, Round N+1, `DevelopmentProvider.replaceCurrent`, PostgreSQL R1 + R2–R13, live Round 2 on `CHG-2026-000005`. R10 proven from rejected-round source/tests, not the live post-Round-2 `round_not_terminal`. Evidence: [`f3-1-3b-implementation-evidence.md`](./f3-1-3b-implementation-evidence.md). |
| F3.1.4 — Composed authorization/governance read representation | **NOT AUTHORIZED** — planning prompt authored (`prompts/f3-1-4-planning.md`); planning execution still requires an explicit launch. No F3.1.4 implementation contract exists yet. F3.1.4 implementation remains **NO-GO**. |
...
| **F3.1.3a official commit**                      | **`6bad066`** (full SHA `6bad066d945d49feaf642313ec37467e2658dc3f`) — CLOSED / ACCEPTED IMPLEMENTED BASELINE |
| **F3.1.3b official commit**                      | **`5e70d88`** (full SHA `5e70d8818f55072d8568b5eb15bae754abb943d1`) — CLOSED / ACCEPTED IMPLEMENTED BASELINE; F3.1.3 decision + resubmission baseline |
