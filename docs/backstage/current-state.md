...
> **Last updated:** 2026-09-21 (F3.1.3a **CLOSED / ACCEPTED IMPLEMENTED BASELINE** at ADO `6bad066`; F3.1.2 remains **CLOSED / ACCEPTED IMPLEMENTED SUBMISSION BASELINE** at parent `2249522`; committed default `LEGACY_PRE_F3`; F3.1.3b implementation-prompt authoring **GO**; F3.1.3b implementation still separately gated; F3.1.4/F3.2 **NO-GO**; production cutover unauthorized)
