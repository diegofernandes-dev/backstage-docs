...
| F3.1.2b — Ledger-governed submission integration | **CLOSED / ACCEPTED IMPLEMENTED BASELINE** at ADO `2249522` (full SHA `22495229502dabf2d99588599a156d862c5114fa`), direct child of product-convergence `f48dc82`. Independent acceptance ACCEPT on 2026-09-20 ([`f3-1-2b-architecture-implementation-acceptance.md`](./f3-1-2b-architecture-implementation-acceptance.md)). Committed default remains `LEGACY_PRE_F3`; LEDGER_REQUIRED proven only in controlled tests. Operational cutover is a later explicit checkpoint. Evidence: [`f3-1-2b-implementation-evidence.md`](./f3-1-2b-implementation-evidence.md). |
| F3.1.2 — First-round submission integration | **CLOSED / ACCEPTED IMPLEMENTED SUBMISSION BASELINE** at ADO `2249522`. Plan remains the ACCEPTED IMPLEMENTATION CONTRACT ([`f3-1-2-final-architecture-rereview.md`](./f3-1-2-final-architecture-rereview.md)). F3.1.2a accepted. F3.1.1c accepted. Product convergence PASS. F3.1.2b accepted. Operational LEDGER_REQUIRED cutover **not authorized**. Canonical plan: [`f3-1-2-implementation-plan.md`](./f3-1-2-implementation-plan.md). |
