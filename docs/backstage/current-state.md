...
| F3.1.3 — Decision command and new-round semantics | Planning **READY_FOR_REVIEW** ([`f3-1-3-implementation-plan.md`](./f3-1-3-implementation-plan.md)) against ADO `2249522` and accepted laptop `LEDGER_REQUIRED` demo target. Recommended slices F3.1.3a (decision command) + F3.1.3b (resubmission); `Migration required: NO`. Implementation **NO-GO** pending independent review + separate implementation prompt. |
