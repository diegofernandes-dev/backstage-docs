...
- [`f3-1-3-planning.md`](./f3-1-3-planning.md) — **completed** with `READY_FOR_REVIEW`. Canonical plan: [`docs/backstage/f3-1-3-implementation-plan.md`](../docs/backstage/f3-1-3-implementation-plan.md). Recommended slices F3.1.3a + F3.1.3b; `Migration required: NO`.
- F3.1.3 implementation remains **NO-GO** until the plan is independently reviewed and a separate implementation prompt is explicitly authorized. Do **not** author that prompt from the planning checkpoint.
