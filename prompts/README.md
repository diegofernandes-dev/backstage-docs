...
- [`f3-1-3-planning.md`](./f3-1-3-planning.md) — **completed** with `READY_FOR_REVIEW`. Canonical plan: [`docs/backstage/f3-1-3-implementation-plan.md`](../docs/backstage/f3-1-3-implementation-plan.md). Recommended slices F3.1.3a + F3.1.3b; `Migration required: NO`. Independently re-verified at docs `7725217` / ADO `2249522`; trx-aware ledger reads are an application contract, not a migration.
